...
<div class="topbar">
  ...
  <nav>
    ...
    <a href="public_population.php?<?= h($navQuery) ?>">ประชากรวัยเรียน</a>
      ...
      <?php else: ?>
        ...
        <div class="stat-grid viz-root">
          ...
          <div class="card stat-tile">
            ...
            <div class="stat-tile-label">ผู้เรียนทั้งหมด</div>
