<?php
/**
 * สมุดสถิติการศึกษาจังหวัดประจำปี — หน้าเปิดเผยต่อสาธารณะ ไม่ต้อง login (ไม่มี Auth::requireLogin()
...
// ตัวเลขหลักที่แสดงในสมุดสถิตินี้ — คัดเฉพาะรายการที่ตรวจสอบกับ reference_templates/ ด้วยมือแล้วว่า
...
<title>สมุดสถิติการศึกษาจังหวัด — ptnedinfo</title>
...
<body>
<div class="topbar">
  <a href="public_report.php">สมุดสถิติการศึกษาจังหวัด</a>
  <nav>
...
<div class="container" style="max-width: 1100px;">
  <div class="card">
    <h1>สมุดสถิติการศึกษาจังหวัด ประจำปีการศึกษา <?= h((string)$selectedYear) ?></h1>
    <p class="muted">สรุปยอดรวมระดับจังหวัดจากข้อมูลที่หน่วยงานทางการศึกษาในจังหวัดส่งกลับผ่านระบบ
      รวบรวมข้อมูลของสำนักงานศึกษาธิการจังหวัด — เป็นตัวเลขสรุประดับสังกัด/อำเภอเท่านั้น
  ...
  <div class="card">
    <p class="muted">ที่มา: ระบบรวบรวมข้อมูลสารสนเทศทางการศึกษา สำนักงานศึกษาธิการจังหวัด —
