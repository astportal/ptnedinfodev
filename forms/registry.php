    ...
    '16_pmj' => [
        ...
        'sheets' => [
            ...
            [
                ...
                // — แม่แบบกรอกรายชื่อสถานรับเลี้ยงเด็กที่ทราบอยู่แล้วไว้ล่วงหน้าในคอลัมน์ "สังกัด"
                // (ไม่ใช่รหัสสถานศึกษา) หน่วยงานกรอกแค่ตัวเลขในแต่ละแถวเท่านั้น — ใช้ agency_name
                // เป็นคีย์กันข้อมูลซ้ำได้ตามปกติ (มีชื่ออยู่แล้ว ไม่ต้องแก้ Importer เพิ่ม)
                'sheet_name'      => 'พมจ-16.2',
                'skip_rows'       => [1, 2],
                'header_rows'     => 4,
                'identity_cols'   => 1,
                'identity_fields' => ['agency_name'],
